  ...
  const terms = [
    {
      ...
      content:
        "By accessing Partnership.top, you confirm that you have read, understood, and agree to these terms. If you do not agree, please discontinue your use of our platform.",
    },
    {
    ...
    },
    {
      ...
      content:
        "Domain sales are long-term investments and may take several years to complete. Investors must exercise patience during this process.",
    },
    {
    ...
    },
    {
      ...
      content:
        "Your personal information will be securely handled in accordance with our Privacy Policy and will only be used for investment-related activities.",
    },
    {
    ...
    },
    {
      ...
      content:
        "Partnership.top reserves the right to update these terms at any time. Continued use of the platform signifies acceptance of any revisions.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm p-8 rounded-xl border border-gray-800 mb-8">
            ...
            <p className="text-gray-300 leading-relaxed">
              Welcome to Partnership.top! By using our platform, you agree to
              abide by the following terms and conditions. Please read them
              carefully to understand your rights and obligations as an
              investor.
            </p>
          </div>
