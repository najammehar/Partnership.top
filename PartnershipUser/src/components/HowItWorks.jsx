  ...
  const steps = [
    {
      ...
      description:
        "Explore our curated collection of premium domain names available for investment. Each domain is carefully selected for its potential to yield high returns.",
    },
    {
      icon: <ScrollText className="w-8 h-8 text-indigo-400" />,
      title: "Choose Your Investment",
      description:
        "Review detailed information about each domain and share availability. Select the domain you want to invest in and choose the number of shares you wish to purchase.",
    },
    {
      icon: <CreditCard className="w-8 h-8 text-indigo-400" />,
      title: "Secure Your Share",
      description:
        "Once you decide, complete the investment process securely through our platform. Your contribution grants you a stake in the future success of the domain.",
    },
    {
      icon: <Coins className="w-8 h-8 text-indigo-400" />,
      title: "Enjoy Your Returns",
      description:
        "When the domain sells, you'll receive your share of the profit, proportional to your investment. It's a simple and transparent way to grow your wealth.",
    },
  ];
  ...
  return (
    <div className="relative min-h-screen pt-20">
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        <h2 className="max-w-4xl mx-auto text-2xl font-bold text-center bg-gradient-to-r from-indigo-400 to-indigo-200 text-transparent bg-clip-text mb-12">
          Welcome to Partnership.top, where domain investing meets opportunity!
